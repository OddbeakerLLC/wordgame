...
This file provides context for AI assistants working on the Word Quest project.

## Project Overview

Word Quest is a Progressive Web App (PWA) for teaching children spelling through interactive drills and adaptive quizzes. Built with vanilla JavaScript, Vite, and IndexedDB.
